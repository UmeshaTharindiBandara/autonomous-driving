    ...
    def spawn_lead_vehicle(self):
        ...
        try:
            ...
            if ego_waypoint is None:
                print("⚠️ Could not find ego waypoint for lead vehicle spawn")
                return False

            next_waypoints = ego_waypoint.next(self.spawn_distance)
            if not next_waypoints:
                print("⚠️ Could not find a forward waypoint for lead vehicle spawn")
                return False
